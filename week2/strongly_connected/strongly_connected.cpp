...
int number_of_strongly_connected_components (vector<single_vertex> &graph, vector<single_vertex> &reverse_graph) {
    int count = 0;
...
int main() {
    ...
    std::cout << number_of_strongly_connected_components(graph,reverse_graph);
}
